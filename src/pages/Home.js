...
const Home = () => {
  return (
    <div className="min-h-screen pt-16 lg:ml-0 bg-gradient-to-br from-emerald-50 to-teal-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Breadcrumbs />
        
        {/* Hero Section */}
        <div className="relative overflow-hidden bg-gradient-to-br from-emerald-500 via-teal-500 to-emerald-600 text-white rounded-3xl p-8 lg:p-10 mb-12 shadow-2xl border border-emerald-400/20">
          <div className="relative z-10 max-w-2xl">
            <h1 className="text-4xl lg:text-5xl font-extrabold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-emerald-100 to-teal-100">
              Tiger Soccer School
            </h1>
            ...
            <button className="group relative inline-flex items-center px-6 lg:px-8 py-3 lg:py-4 rounded-xl font-bold overflow-hidden">
              <span className="absolute inset-0 w-full h-full bg-gradient-to-br from-white to-emerald-100 transition-all duration-300 group-hover:scale-105"></span>
              <span className="relative text-emerald-600 font-bold">
                Daftar Sekarang
              </span>
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="group bg-white p-6 lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-emerald-100/50 hover:border-emerald-200 hover:-translate-y-1">
